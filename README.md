...
Incluye los archivos principales (index.js y package.json) y está pensado para que puedan probar los comandos de manera simple.

# Comandos disponibles
- npm run start GET products → Muestra todos los productos.  
